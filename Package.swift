...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/multijam/SwiftGodot", revision: "ca05d1e4b7fee517e9fa2cf1619b8ea5fa4be3b6")
    ...
    targets: [
        ...
        .binaryTarget (
            ...
            url: "https://github.com/multijam/SwiftGodot/releases/download/v0.0.4/libgodot.xcframework.zip",
            checksum: "4cd082018aba7f6c0e00b237b2d219619076493d5d361aadbec29bd731c99efc"
        ),
        .systemLibrary(
            name: "libgodot"
        ),
